 ...
 * @author ASUS
 */
public class AjoutReclamationForm extends Form implements LocalNotificationCallback {
    
    Form current;
    Photo photo;

    public AjoutReclamationForm(Resources res,Photo photo) {
         ...
         */
        //
        TextField sujet = new TextField("", "enter sujet");
        ...
        btnAjouter.addActionListener((ActionEvent e) -> {
            ...
            try {
                ...
                if (sujet.getText().equals("") || description.getText().equals("")) {
                    ...
                    r.setId_photo(this.photo.getid_photo());                    
                    r.setId_user(29);
